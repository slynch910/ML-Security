...
class DT:
    ...
    # Constructor
    ####################################################    
    def __init__(self, datasetPath="datasets/iot_23_dataset.csv"):
    ...
    def perform_cross_validation(self):
        ...
        with open("results/dt_results_iot.csv", "w") as out:
        ...
        print(f"[+] Creating Confusion Matrix for IOT dataset...")
        disp = ConfusionMatrixDisplay(
            confusion_matrix=confusion_matrix(self.Y_test, self.y_pred), 
        ).plot()

        plt.savefig(f"results/IOT_confusion_matrix.png") 
